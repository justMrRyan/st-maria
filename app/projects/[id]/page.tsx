                ...
                <div className="relative">
                  {imageUrls.length > 0 ? (
                      <div className="relative aspect-[4/3] bg-[#f8f4f0] overflow-hidden group">
                        ...
                        {/* Controls */}
                        <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex items-center gap-4 bg-black/50 backdrop-blur-sm px-4 py-2">
                          {imageUrls.length > 1 && (
                              <>
                                <button
                                    onClick={(e) => { e.stopPropagation(); setIsAutoPlaying(!isAutoPlaying); }}
                                    className="text-white hover:text-[#d4c5b0] transition-colors"
                                >
